...
delt_k2	 = delt_DM * ( k2_rsl**-1 ) * C * nbin
delt_k3	 = 1./delt_k2
print 'delta K:',delt_k3
cot_grid = abs((cot_max-cot_min)/ delt_k3)*2
#print cot_grid
#exit()
rad_grid = data.size / cot_grid
...
grid_c	= np.linspace(cot_min,cot_max,int(cot_grid))
#grid_a = np.tan(grid_a/180.*np.pi)
#print grid_r.max(),grid_r.min(),'/*/*/*'
grid_t,grid_r = np.meshgrid(grid_c,grid_r)
#print grid_r[0,:]
#print grid_r[-1,:]
